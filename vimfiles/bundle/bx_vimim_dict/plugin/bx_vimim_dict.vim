...
elseif exists('g:bx_im_sky_bear_used') && g:bx_im_sky_bear_used
    let g:bx_im_code_fn = 'bx_vimim_sky_bear.txt'
    let g:bm_im_charfirst = [12,3125,14829,21691,35437,38439,46170,57103,69491,79595,92528,99833,113183,123399,131558,132665,139894,148789,155217,162768,172024,184900,197165,205575,217079,231380]
else
